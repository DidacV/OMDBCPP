...
public:
    ...
    inline int get_total_rating() const;
...
inline int Movie::get_total_rating() const{ return total_rating; }

inline bool operator>(const Movie &m_a, const Movie &m_b) {return m_a.get_title() > m_b.get_title();}
